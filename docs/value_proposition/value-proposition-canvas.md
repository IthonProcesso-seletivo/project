...
- Gerenciar patrimônio imobiliário e fluxo de caixa de aluguéis
- Controlar gastos de dependentes e identificar quem realizou cada despesa
- Separar gastos fixos de variáveis para otimizar a economia mensal

Dores Atuais (Pains)
- Dificuldade em enxergar o destino final do dinheiro no fim do mês
- Confusão entre lucro real e giro de caixa ou despesas de manutenção
- Falta de controle sobre os gastos realizados por outros membros da família
- Insegurança quanto a prazos de reajuste de contratos e seguros

Ganhos Desejados (Gains)
- Visualizar o saldo real da família imediatamente após o pagamento das contas fixas
- Ter um diagnóstico da saúde financeira em menos de 1 minuto

...
RF01 - Consolidação de Contas: Integração de saldos e gastos de diferentes bancos e cartões em uma única interface.

RF02 - Identificação de Gastos por Membro: Sistema de perfis ou tags para rastrear a origem de cada despesa familiar.
...
RF07 - Gráficos de Evolução: Visualização intuitiva do crescimento patrimonial ao longo do tempo.

RF08 - Relatório Consolidado: Visualização rápida na plataforma de todas as entradas e estados das contas (Apenas visualização, sem suporte a PDF).
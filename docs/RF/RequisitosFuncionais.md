...
RF01 - Cadastro de Usuário: Permitir o registro de novos utilizadores no sistema.

RF02 - Autenticação (Login): Sistema de login para garantir que apenas usuários autorizados acessem os dados.

RF03 - Edição de Perfil: Permitir que o usuário altere suas informações cadastrais.

RF04 - Exclusão de Conta: Opção para o usuário remover permanentemente seu registro e dados do sistema.
...
RF07 - Edição e Exclusão de Gastos: Permitir que o usuário corrija ou remova lançamentos de despesas.

RF08 - Cadastro de Receita: Registro de entradas financeiras (salários, bônus, etc.) para cálculo do saldo.
...
RF12 - Cadastro de Patrimônio: Registro de ativos imobiliários e outros bens da família.

    ...
    <div className="min-h-screen bg-[#F2F6F2] flex flex-col items-center font-sans pb-12">
      ...
      <div className="max-w-md w-full px-6 flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-5 top-1/2 -translate-y-1/2 text-black/30 hover:text-black/50 transition-colors"
              >
                {showPassword ? (
                  <svg
                  ...
                  >
                    <path
                      ...
                      d="M2.036 12.322a1.012 1.012 0 010-.644M12 4.945c-4.406 0-8.02 3.17-9.964 7.378a1.022 1.022 0 000 .846c1.944 4.208 5.558 7.378 9.964 7.378 4.406 0 8.02-3.17 9.964-7.378a1.022 1.022 0 000-.846c-1.944-4.208-5.558-7.378-9.964-7.378z"
                    />
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
          ...
          <button
            type="submit"
            className="w-full bg-[#2D815D] hover:bg-[#236847] transition-colors text-white font-semibold py-3 rounded-full shadow-md mt-2"
          >
            Entrar
          </button>
        </form>
        ...
        <p className="text-gray-500 text-sm mt-6 text-center">
          Não tem conta?{" "}
          <Link
            className="text-[#2D815D] font-semibold hover:underline"
            to="/register"
          >
            Criar agora
          </Link>
